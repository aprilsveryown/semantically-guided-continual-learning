...
_BIG_DATA_PATH = "/data/datasets"

dataset_config = {
    'mnist': {
        'path': join(_BIG_DATA_PATH, 'mnist'),
    ...
    'vggface2': {
        'path': join(_BIG_DATA_PATH, 'VGGFace2'),
        'resize': 256,
        'crop': 224,
        'flip': True,
    ...
    'imagenet_256': {
        'path': join(_BIG_DATA_PATH, 'imagenet/'),
        'resize': 256,
        'crop': 224,
        'flip': True,
        'normalize': ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
    ...
    'flowers102': {
        'path': join(_BIG_DATA_PATH, 'flowers'),
        'resize': 256,
        'crop': 224,
        'flip': True,
        'normalize': ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
    ...
    'caltech': {
        'path': join(_BIG_DATA_PATH, 'Caltech101/images'),
        'resize': 256,
        'crop': 224,
        'flip': True,
        'normalize': ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
    ...
    'cifar-10': {
        'path': join(_BIG_DATA_PATH, 'cifar10'),
        'resize': 224,
        'pad': 4,
        'crop': 224,
        'flip': True,
    ...
    'imagenet-r': {
        'path': join(_BIG_DATA_PATH, 'imagenet_r/'),
        'resize': 224,
        'pad': 4,
        'crop': 224,
        'flip': True,
